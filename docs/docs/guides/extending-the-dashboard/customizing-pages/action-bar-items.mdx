...
3. Hover the page or existing action bar item to reveal its IDs
4. Use these IDs in your action bar item configuration

The [Extension Targets reference](/extending-the-dashboard/customizing-pages/extension-targets/) lists the most common built-in page IDs, block IDs, action bar item IDs, and toolbar item IDs.
