...
In Dev Mode, hovering blocks, action bar items, toolbar items, and navigation entries will show the IDs you need when customizing the dashboard. These include values such as `pageId`, `blockId`, `itemId`, and nav section/item IDs.

This is essential for:

- Identifying where to place custom page blocks
- Finding action bar locations
- Finding toolbar item IDs
- Finding navigation section and item IDs
