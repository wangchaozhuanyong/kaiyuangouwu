...
metaDescription: "Explore the technologies behind the Vendure Dashboard: React 19, Vite 7, Tailwind CSS v4, TanStack Query/Router, React Hook Form, gql.tada, and more."
---
...
[Vite 7](https://vite.dev/) powers the development experience with:
...
The Vendure Design System is based on [Base UI](https://base-ui.com/), [Shadcn/ui](https://ui.shadcn.com/) and Tailwind, providing:
