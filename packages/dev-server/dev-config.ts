    ...
    customFields: {
        ...
        Channel: [
            ...
            },
            {
                ...
                ui: { dashboard: false },
                label: [
                    { languageCode: LanguageCode.zh_Hans, value: 'USDT 报价加价基点' },
                    { languageCode: LanguageCode.en, value: 'USDT quote markup (bps)' },
                ],
            },
            {
            ...
            },
            {
                ...
                ui: { dashboard: false },
                label: [
                    { languageCode: LanguageCode.zh_Hans, value: '每 USDT 对应人民币' },
                    { languageCode: LanguageCode.en, value: 'CNY per USDT' },
                ],
            },
            {
                name: 'usdtRateSource',
                ...
                ui: { dashboard: false },
                label: [
                    { languageCode: LanguageCode.zh_Hans, value: 'USDT 报价来源' },
                    { languageCode: LanguageCode.en, value: 'USDT quote source' },
                ],
            },
            {
                name: 'usdtRateUpdatedAt',
                type: 'datetime',
                nullable: true,
                public: false,
                ui: { dashboard: false },
                label: [
                    { languageCode: LanguageCode.zh_Hans, value: 'USDT 报价更新时间' },
                    { languageCode: LanguageCode.en, value: 'USDT quote updated at' },
                ],
            },
        ],
    },
