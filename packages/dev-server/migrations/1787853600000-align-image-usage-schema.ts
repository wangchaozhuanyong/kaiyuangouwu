...
const AUDIT_TERMS_VERSION_DEFAULT = "'2026-08-28-audit'";
const LEGACY_TERMS_VERSION_DEFAULT = "'2026-08-27'";
...
export class AlignImageUsageSchema1787853600000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await this.alignColumn(queryRunner, 'image_generation_config', 'termsVersion', column => {
            ...
            column.default = AUDIT_TERMS_VERSION_DEFAULT;
        });
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await this.alignColumn(queryRunner, 'image_generation_config', 'termsVersion', column => {
            ...
            column.length = '32';
            column.isNullable = false;
            column.default = LEGACY_TERMS_VERSION_DEFAULT;
        });
        await this.alignColumn(queryRunner, 'image_usage_quota_bucket', 'version', column => {
            column.type = 'int';
            column.isNullable = false;
    ...
    private async alignColumn(
        ...
        const current = table?.findColumnByName(columnName);
