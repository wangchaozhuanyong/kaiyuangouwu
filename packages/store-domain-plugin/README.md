...
- `STORE_DOMAIN_ROUTING_MODE`: use `require-domain` in production to reject unbound Shop API hosts;
  the default `prefer-domain` keeps local token-based development working.
