...
describe('PromptRulesService', () => {
    ...
    it('routes identity-preserving reference work to GPT image', () => {
        ...
        expect(rules.recommendation(spec).modelCode).toBe('OPENAI_HIGH_QUALITY');
    });

    it('routes transparent product cutouts to OpenAI high quality', () => {
