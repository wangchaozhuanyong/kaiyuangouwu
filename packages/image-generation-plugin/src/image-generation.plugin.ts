...
import { purgeExpiredPrivateImagesTask, reconcileImageGenerationsTask } from './image-generation.tasks';
...
@VendurePlugin({
    ...
    configuration: config => {
        ...
        config.schedulerOptions.tasks.push(reconcileImageGenerationsTask, purgeExpiredPrivateImagesTask);
        return config;
    },
    adminApiExtensions: {
