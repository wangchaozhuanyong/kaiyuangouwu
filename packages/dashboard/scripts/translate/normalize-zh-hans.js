...
const exactTranslations = new Map([
    ...
    ['Drag {item}', '拖动 {item}'],
    ['Remove {item}', '移除 {item}'],
    ['Remove {channelDisplayName}', '移除 {channelDisplayName}'],
    ['Name (Simplified Chinese)', '名称（简体中文）'],
    ['Option group name (Simplified Chinese)', '规格名称'],
