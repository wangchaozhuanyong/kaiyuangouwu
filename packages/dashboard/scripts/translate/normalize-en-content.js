...
const explicitIdTranslations = new Map([
    ...
    ['fieldName.administrator', 'Administrator'],
    ...
    ['fieldName.productCount', 'Products'],
    ['fieldName.productId', 'Product ID'],
    ['fieldName.productVariantCount', 'Product SKU count'],
    ...
    ['fieldName.variants', 'Product SKUs'],
    ['fieldName.zone', 'Zone'],
