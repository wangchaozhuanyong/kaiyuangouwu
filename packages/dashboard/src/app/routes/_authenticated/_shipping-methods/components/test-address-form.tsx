                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <FormFieldWrapper
                                ...
                                render={({ field }) => <Input {...field} placeholder={t`Zhang Wei`} />}
                            />
                            <FormFieldWrapper
                                control={form.control}
                                name="company"
                        ...
                        <FormFieldWrapper
                            ...
                            render={({ field }) => (
                                <Input {...field} placeholder={t`No. 88, Nanjing West Road`} />
                            )}
                        />
                        ...
                        <FormFieldWrapper
                            ...
                            render={({ field }) => (
                                <Input
                                    {...field}
                                    value={field.value || ''}
                                    placeholder={t`Building, unit, room, etc.`}
                                />
                            )}
                        />
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <FormFieldWrapper
                                ...
                                render={({ field }) => <Input {...field} placeholder={t`Shanghai`} />}
                            />
                            <FormFieldWrapper
                                control={form.control}
                                name="province"
                                ...
                                render={({ field }) => (
                                    <Select
                                        items={
                                            countriesData
                                                ? Object.fromEntries(
                                                      countriesData.countries.items.map(c => [
                                                          c.code,
                                                          c.name,
                                                      ]),
                                                  )
                                    ...
                                    >
                                        <SelectTrigger>
                                            <SelectValue placeholder={t`Select a country or region`} />
                                        </SelectTrigger>
                                        <SelectContent>
