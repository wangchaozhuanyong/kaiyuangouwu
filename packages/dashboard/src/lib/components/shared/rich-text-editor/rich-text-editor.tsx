    ...
    const editor = useEditor(
        {
            ...
            onUpdate: ({ editor: updatedEditor }) => {
                if (!disabled && !updatedEditor.isDestroyed) {
            ...
            editorProps: {
                attributes: {
                    ...
                    class: [
                        'rich-text-editor placeholder:text-muted-foreground focus-visible:border-ring',
                        'focus-visible:ring-ring/10 aria-invalid:ring-destructive/20',
                        'dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
                        'field-sizing-content min-h-16 w-full bg-transparent px-3 py-2 text-base',
                        'transition-[color,box-shadow] outline-none md:text-sm max-h-[500px] overflow-y-auto',
