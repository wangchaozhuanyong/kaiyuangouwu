        ...
        return (
            <div className="w-[300px] space-y-4">
                <div className="space-y-2">
                    <label htmlFor="money-usd" className="text-sm font-medium">
                        USD
                    </label>
                ...
                <div className="space-y-2">
                    <label htmlFor="money-eur" className="text-sm font-medium">
                        EUR
                    </label>
                ...
                <div className="space-y-2">
                    <label htmlFor="money-gbp" className="text-sm font-medium">
                        GBP
                    </label>
                ...
                <div className="space-y-2">
                    <label htmlFor="money-jpy" className="text-sm font-medium">
                        JPY
                    </label>
