...
const renderStructFieldInput = (
    ...
    const renderSingleStructInput = (singleField: ControllerRenderProps<any, any>) => {
        ...
        if (customComponentId) {
            ...
            if (CustomComponent) {
                ...
                return (
                    <CustomComponent {...singleField} fieldDef={structField as any} disabled={isReadonly} />
                );
            }
        }
    ...
    if (customComponentId) {
        ...
        if (CustomComponent) {
            ...
            if (
                CustomComponent.metadata?.isListInput === true ||
                CustomComponent.metadata?.isListInput === 'dynamic'
            ) {
                // Cast to any since struct fields share the relevant properties with ConfigurableFieldDef
                return (
                    <CustomComponent {...inputField} fieldDef={structField as any} disabled={isReadonly} />
                );
            }
        }
    }
