...
const navigationTitles: OperationsNavigationTitles = {
    ...
    storeAndMerchants: 'operations.nav.storeAndMerchants',
    commerceAndRegions: 'operations.nav.commerceAndRegions',
    aiServices: 'operations.nav.aiServices',
    accountsAndAccess: 'operations.nav.accountsAndAccess',
    systemOperations: 'operations.nav.systemOperations',
