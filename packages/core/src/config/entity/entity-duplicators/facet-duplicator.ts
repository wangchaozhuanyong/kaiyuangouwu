...
export const facetDuplicator = new EntityDuplicator({
    ...
    description: [
        {
            ...
            value: 'Duplicate this filter attribute',
        },
        { languageCode: LanguageCode.zh_Hans, value: '复制该筛选属性' },
    ],
    ...
    args: {
        includeFacetValues: {
            ...
            defaultValue: true,
            label: [
                { languageCode: LanguageCode.en, value: 'Include attribute values' },
                { languageCode: LanguageCode.zh_Hans, value: '同时复制属性值' },
            ],
            description: [
                {
                    languageCode: LanguageCode.en,
                    value: 'Copy all values belonging to this filter attribute.',
                },
                { languageCode: LanguageCode.zh_Hans, value: '开启后，同时复制该筛选属性下的全部属性值。' },
            ],
        },
    },
