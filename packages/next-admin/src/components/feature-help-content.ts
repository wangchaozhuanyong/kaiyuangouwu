...
export const featureHelpContent = {
    ...
    'settings.governance-risk': {
        purpose: '集中管理受控配置的双人审批、订单风险复核、客户申诉、每日治理报告和哈希审计链。',
        requirements: ['配置提交人与批准人必须是不同管理员', '风险放行或拦截必须填写可复核的决定依据'],
        example: '例如：管理员 A 提交新反欺诈阈值，管理员 B 核对配置摘要后批准，新版本才会激活。',
        impact: '高风险订单在进入支付前会被暂缓；批准放行后客户可以继续，拒绝后客户仍可提交申诉。',
    },
