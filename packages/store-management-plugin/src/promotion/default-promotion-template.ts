...
export const DEFAULT_PROMOTION_TEMPLATE_VERSION = 23;
...
<head>
    ...
    <style>
        :root { color-scheme:dark; --black:#090b0d; --black-soft:#0d1013; --panel:#111519; --panel-soft:#171b1f; --white:#f4f2ed; --white-soft:#c7c7c3; --muted:#92969a; --faint:#686d72; --silver:#b7bcc0; --amber:#efa83f; --amber-bright:#ffc65f; --amber-ink:#191006; --line:rgba(214,216,216,.15); --line-strong:rgba(239,168,63,.58); --promo-focus-color:#ffc65f; --shell:min(1200px,calc(100% - 48px)); --section-top:clamp(76px,6.4vw,108px); --section-bottom:clamp(56px,4.8vw,82px); --ease:cubic-bezier(.16,1,.3,1); }
        * { box-sizing:border-box; }
        html { overflow-x:hidden; overflow-x:clip; scroll-behavior:smooth; background:var(--black); }
        ...
        .promo-section { position:relative; padding:var(--section-top) 0 var(--section-bottom); background-color:#0d1013; background-image:url("/storefront/promo/damatong-silver-stage-v23.webp"); background-position:right top; background-size:1536px auto; background-repeat:no-repeat; background-blend-mode:multiply; }
        .promo-section::before { position:absolute; inset:0; border-top:1px solid rgba(235,224,206,.035); content:""; pointer-events:none; }
        ...
        .promo-services { padding-top:30px; background-color:#111316; }
        .promo-services-layout { display:grid; grid-template-columns:minmax(280px,.78fr) minmax(0,1.22fr); gap:clamp(58px,9vw,124px); align-items:start; }
        ...
        .promo-scenarios { overflow:hidden; background-color:#0c0f12; background-image:url("/storefront/promo/damatong-silver-stage-v23.webp"); background-position:right top; background-size:cover; background-repeat:no-repeat; background-blend-mode:multiply; }
        .promo-scenarios::after { position:absolute; inset:0; background:rgba(8,10,12,.86); content:""; pointer-events:none; }
        ...
        .promo-theater { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); border-top:1px solid var(--line-strong); }
        .promo-scene { min-height:220px; display:grid; align-content:end; gap:14px; padding:42px; border-right:1px solid var(--line); border-bottom:1px solid var(--line); background:rgba(12,15,18,.58); transition:background 260ms ease,transform 300ms var(--ease); }
        .promo-scene:nth-child(2n) { border-right:0; }
        .promo-scene:nth-last-child(-n+2) { border-bottom:0; }
        .promo-scene:hover,.promo-scene.is-scene-active { background:rgba(25,20,14,.72); transform:translateY(-4px); }
        .promo-scene-index { color:var(--amber); font-size:10px; font-weight:720; letter-spacing:.16em; }
        ...
        .promo-process { background-color:#101215; background-position:center bottom; }
        ...
        .promo-process-path { position:relative; display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); margin:0; padding:36px 0 0; border-top:1px solid var(--line-strong); list-style:none; }
        .promo-step { position:relative; min-height:220px; padding:0 clamp(24px,3vw,38px) 0 0; }
        .promo-step+.promo-step { padding-left:clamp(24px,3vw,38px); border-left:1px solid var(--line); }
        .promo-step-number { display:block; margin-bottom:30px; color:var(--amber); font-size:11px; font-weight:720; letter-spacing:.16em; }
        ...
        .promo-trust-section { padding-bottom:48px; background-color:#111316; background-position:center top; }
        ...
        .promo-trust-item { display:grid; grid-template-columns:38px minmax(0,1fr); gap:20px; padding:23px 0; border-bottom:1px solid var(--line); }
        .promo-trust-item:last-child { border-bottom:0; }
        .promo-trust-number { color:var(--amber); font-size:10px; font-weight:720; letter-spacing:.14em; }
        ...
        .promo-mobile-entry { position:fixed; z-index:70; right:14px; bottom:14px; left:14px; display:none; padding:7px; border:1px solid rgba(242,167,75,.38); background:rgba(8,10,12,.92); box-shadow:0 16px 48px rgba(0,0,0,.44); -webkit-backdrop-filter:blur(18px); backdrop-filter:blur(18px); opacity:0; pointer-events:none; transform:translateY(120%); transition:opacity 260ms ease,transform 320ms var(--ease); }
        ...
        @media (max-width:760px) {
            ...
            .promo-header-entry { min-height:40px; padding-inline:13px; font-size:11px; }
            ...
            .promo-secondary-button { min-height:42px; }
            ...
            .promo-kicker { justify-content:center; margin-bottom:16px; }
            .promo-section-title { max-width:15ch; margin-inline:auto; font-size:clamp(32px,8.4vw,36px); line-height:1.14; text-align:center; }
            .promo-section-intro { max-width:36ch; margin:18px auto 0; font-size:14px; text-align:center; }
            .promo-scenario-copy .promo-section-intro,.promo-process-heading .promo-section-intro { margin:18px auto 0; }
            .promo-services { padding-top:48px; }
            .promo-services-layout { grid-template-columns:1fr; gap:38px; }
            .promo-services-copy { position:static; text-align:center; }
            ...
            .promo-section { background-image:url("/storefront/promo/damatong-silver-stage-mobile-v23.webp"); background-position:right top; background-size:1024px auto; }
            .promo-scenarios { background-position:right top; background-size:cover; }
            .promo-scenario-copy { margin-bottom:34px; }
            .promo-theater { grid-template-columns:1fr; }
            .promo-scene { min-height:0; padding:28px 0; border-right:0; border-bottom:1px solid var(--line); background:transparent; }
            .promo-scene:nth-last-child(-n+2) { border-bottom:1px solid var(--line); }
            .promo-scene:last-child { border-bottom:0; }
            .promo-scene strong { font-size:22px; }
            .promo-process-heading { margin-bottom:36px; }
            .promo-process-path { grid-template-columns:1fr; padding-top:0; border-top:0; }
            .promo-step { min-height:0; display:grid; grid-template-columns:38px minmax(0,1fr); gap:8px 14px; padding:24px 0 28px; border-top:1px solid var(--line); }
            .promo-step+.promo-step { padding-left:0; border-left:0; }
            .promo-step-number { grid-row:1 / span 2; margin:4px 0 0; }
            .promo-step p { grid-column:2; margin-top:4px; }
            ...
            .promo-trust-item { grid-template-columns:34px minmax(0,1fr); gap:12px; }
...
<body>
    ...
    <div class="promo-page" data-promo-page data-promo-motion>
        <div class="promo-header-wrap"><header class="promo-header" data-promo-header><div class="promo-header-inner">
            <a class="promo-brand" href="#promo-main" aria-label="Damatong"><img class="promo-brand-mark" src="/storefront/promo/damatong-amber-mark-v15.webp" alt=""><span class="promo-brand-name">Damatong</span></a>
        ...
        <main id="promo-main">
            ...
            <section class="promo-section promo-scenarios" id="scenarios"><div class="promo-shell promo-scenario-layout"><div class="promo-scenario-copy" data-promo-reveal><div><p class="promo-kicker">{{promo.navScenarios}}</p><h2 class="promo-section-title">{{promo.scenariosTitle}}</h2></div><p class="promo-section-intro">{{promo.scenariosIntro}}</p></div><div class="promo-theater">
                <article class="promo-scene" data-promo-scene-item data-promo-reveal><span class="promo-scene-index">01</span><strong>{{promo.scenarioPersonalTitle}}</strong><p>{{promo.scenarioPersonalDescription}}</p></article><article class="promo-scene" data-promo-scene-item data-promo-reveal><span class="promo-scene-index">02</span><strong>{{promo.scenarioCreatorTitle}}</strong><p>{{promo.scenarioCreatorDescription}}</p></article><article class="promo-scene" data-promo-scene-item data-promo-reveal><span class="promo-scene-index">03</span><strong>{{promo.scenarioDeveloperTitle}}</strong><p>{{promo.scenarioDeveloperDescription}}</p></article><article class="promo-scene" data-promo-scene-item data-promo-reveal><span class="promo-scene-index">04</span><strong>{{promo.scenarioTeamTitle}}</strong><p>{{promo.scenarioTeamDescription}}</p></article>
            </div></div></section>
            <section class="promo-section promo-process" id="process"><div class="promo-shell"><div class="promo-process-heading" data-promo-reveal><div><p class="promo-kicker">{{promo.navProcess}}</p><h2 class="promo-section-title">{{promo.processTitle}}</h2></div><p class="promo-section-intro">{{promo.processIntro}}</p></div><ol class="promo-process-path"><li class="promo-step" data-promo-reveal><span class="promo-step-number">01</span><div><strong>{{promo.processStepOneTitle}}</strong><p>{{promo.processStepOneDescription}}</p></div></li><li class="promo-step" data-promo-reveal><span class="promo-step-number">02</span><div><strong>{{promo.processStepTwoTitle}}</strong><p>{{promo.processStepTwoDescription}}</p></div></li><li class="promo-step" data-promo-reveal><span class="promo-step-number">03</span><div><strong>{{promo.processStepThreeTitle}}</strong><p>{{promo.processStepThreeDescription}}</p></div></li><li class="promo-step" data-promo-reveal><span class="promo-step-number">04</span><div><strong>{{promo.processStepFourTitle}}</strong><p>{{promo.processStepFourDescription}}</p></div></li></ol></div></section>
            <section class="promo-section promo-trust-section"><div class="promo-shell promo-trust-panel" data-promo-reveal><div><p class="promo-kicker">Damatong</p><h2>{{promo.trustTitle}}</h2><p>{{promo.trustIntro}}</p></div><ul class="promo-trust-list"><li class="promo-trust-item"><span class="promo-trust-number">01</span><div><strong>{{promo.trustOneTitle}}</strong><p>{{promo.trustOneDescription}}</p></div></li><li class="promo-trust-item"><span class="promo-trust-number">02</span><div><strong>{{promo.trustTwoTitle}}</strong><p>{{promo.trustTwoDescription}}</p></div></li><li class="promo-trust-item"><span class="promo-trust-number">03</span><div><strong>{{promo.trustThreeTitle}}</strong><p>{{promo.trustThreeDescription}}</p></div></li></ul></div></section>
