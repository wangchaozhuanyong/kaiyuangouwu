...
const PROMOTION_ZH_COPY = {
    ...
    trustTwoDescription: '从个人创业、内容创作到开发接入与团队使用，都能按任务找到对应方向。',
...
const PROMOTION_EN_COPY: Record<PromotionCopyKey, string> = {
    ...
    trustTwoDescription:
        'Entrepreneurship, content creation, developer integration, and team workflows each have a clear direction.',
