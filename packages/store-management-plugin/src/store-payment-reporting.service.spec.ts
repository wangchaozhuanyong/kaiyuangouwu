...
describe('StorePaymentReportingService', () => {
    ...
    it('scopes both payment and refund aggregates to the active merchant Channel', async () => {
    ...
    it('keeps non-settled payments in details without counting them as collected money', async () => {
        ...
        const connection = {
            getRepository: vi.fn(() => ({ createQueryBuilder: vi.fn(() => detailsQuery) })),
        };
        const service = new StorePaymentReportingService(connection as any);
