                                            ...
                                            onToggleDefaultTemplate={(id, enabled) => {
                                                ...
                                                if (!enabled && draft.defaultPosterTemplate === id) {
                                                    ...
                                                    if (allRemaining.length > 0) {
                                                        ...
                                                        toast.info(
                                                            `默认模板已顺延调整为「${posterLabel(nextDefault)}」`,
                                                        );
                                                    }
                                                }
                                                setDraft({
            ...
            <div>
                <div>
                    ...
                    <p className="mb-0 mt-1 max-w-3xl text-sm leading-6 text-muted-foreground">
                        系统内置 5
                        款全屏移动端海报模板（1080×1920）。您可以通过“在客户端显示”开关控制是否在客户端展示，只有开启的模板会出现在买家前台列表中。
                    </p>
                </div>
                                    ...
                                    <div className="flex items-center justify-between rounded-lg border bg-muted/40 px-3 py-2">
                                        ...
                                        <Switch
                                            ...
                                            onCheckedChange={checked =>
                                                onToggleDefaultTemplate(sys.id, checked)
                                            }
                                        />
                                    </div>
                                    <Button
                            ...
                            <div className="space-y-3 p-4">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        disabled={
                                            disabled || !template.enabled || defaultTemplate === template.id
                                        }
