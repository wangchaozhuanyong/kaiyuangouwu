...
import {
    CustomPosterTemplateCard,
    SYSTEM_POSTER_TEMPLATES,
    SystemPosterTemplatesSection,
} from '../referral/referral-poster-cards';
...
function PosterTemplateManager({
    ...
    return (
        <section className="border-t pt-6 space-y-8">
            {/* 系统预置海报模板 */}
            <SystemPosterTemplatesSection
                enabledDefaultTemplates={enabledDefaultTemplates}
                defaultTemplate={defaultTemplate}
                disabled={disabled}
                onToggleDefaultTemplate={onToggleDefaultTemplate}
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    {templates.map(template => (
                        <CustomPosterTemplateCard
                            ...
                            onEdit={() => setDraft(posterTemplateDraft(template))}
                            onMakeDefault={() => onMakeDefault(template.id)}
                            onDelete={() => {
