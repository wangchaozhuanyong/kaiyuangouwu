...
interface PlatformUsdtPaymentManagementResult {
    ...
    storePaymentDetails: StorePaymentDetailRecord[];
    storeUsdtManualRefunds: StoreUsdtManualRefundRecord[];
}
...
function UsdtPaymentManagementPage() {
    ...
    const query = useQuery({
        queryKey: ['platform-usdt-payment-management', channelId],
        queryFn: () =>
    ...
    const paymentDetails = query.data?.storePaymentDetails ?? [];
    const manualRefunds = query.data?.storeUsdtManualRefunds ?? [];
        ...
        <Page pageId="usdt-payment-management">
            ...
            <PageLayout>
                ...
                <PageBlock
                    ...
                    title="全部支付方式明细"
                    description="最新 200 笔支付；未结算支付也会显示，但不计入实收。"
                >
