...
const zhCopy = {
    ...
    template: '选择基础店铺',
    selectTemplate: '选择要复制配置的现有店铺',
    templateHelp:
        '创建时会复制所选店铺的语言、币种、税务和库存默认值，并共享其库存点、支付和配送方式；创建后不会自动同步基础字段。',
    noTemplates: '暂时没有可作为基础配置的店铺，请检查 Channel 配置。',
    administrator: '后台管理员',
    firstName: '名',
    lastName: '姓',
    email: '登录邮箱',
...
const enCopy: typeof zhCopy = {
    ...
    template: 'Base store',
    selectTemplate: 'Select an existing store to copy',
    templateHelp:
    ...
    noTemplates: 'No existing store is available as a configuration source. Check the Channels first.',
    ...
    submit: 'Create store',
    submitting: 'Creating',
    loadError: 'Could not load base stores',
    retry: 'Retry',
